...
The PR title becomes the squash commit subject — it must be a valid Conventional Commit (`feat:` MINOR, `fix:`/`perf:`/`refactor:` PATCH, `!`/`BREAKING CHANGE:` MAJOR) and must respect commitlint's 72-char header limit.
